...
exports.getBusinessById = exports.searchSuggestions = exports.listBusinesses = void 0;
...
const listBusinesses = async (req, res) => {
    try {
        const { page = "1", // Default page number as string
        ...
        const businessesWithDistance = businesses
            .map((business) => {
            const distanceInMeters = (0, geolib_1.getDistance)({ latitude: userLatitude, longitude: userLongitude }, { latitude: business.latitude, longitude: business.longitude });
        ...
        const paginatedBusinesses = businessesWithDistance.slice((pageNum - 1) * limit, pageNum * limit);
        // Response
        res.status(200).json({
